...
class Skillcraft(object):
    def __init__(self, dataset_dir=None, subsample_ratio=1.0, test_ratio=0.1,
                 split_seed=0, **kwargs):
        if dataset_dir is None:
            self.dataset_dir = '/datasets/uci/skillcraft'
        else:
    ...
    def _preprocess(self, subsample_ratio, test_ratio, split_seed):
        file_path = os.path.join(self.dataset_dir, 'skillcraft.mat')
